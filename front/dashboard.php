...
echo "<div class='col-md-2 d-flex'><div class='card card-stat shadow-sm border-start border-4 border-secondary h-100 w-100'><div class='card-body d-flex flex-column'><div class='text-muted small'>" . __('Escolas ativas', 'protocolo') . "</div><div class='h3 mb-0'>$totalEscolas</div><a href='" . Escola::getSearchURL() . "' class='small mt-auto'>Gerenciar &rarr;</a></div></div></div>";
